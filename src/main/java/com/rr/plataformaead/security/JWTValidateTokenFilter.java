...
public class JWTValidateTokenFilter extends OncePerRequestFilter {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(JWTValidateTokenFilter.class);

    public JWTValidateTokenFilter() {
    }

    public JWTValidateTokenFilter(JwtUtils jwtUtils, UserDetailsServiceImpl userDetailsService) {
